...
// Function to process button for different Color options
...
// Function to process button for different Fill options
...
int main()
{
    ...
    // While the red close button is not pressed
    while (running)
    {
        // Displays menu to color various maps
        sf::RenderWindow startWindow(sf::VideoMode(600, 400), "Choose a map");

        // Sets up text functionality
        sf::Font font;
        ...
        while (startWindow.isOpen())
        {
            ...
            while (startWindow.pollEvent(event))
                ...
                switch (event.type)
                {
                    ...
                    // Based on which word is clicked, the map is set to that word
            ...
            // Displays text to the menu window
            startWindow.clear();
        ...
        // Map is set up for the new window based on the map name clicked prior
        background.setPosition(1, texture.getSize().y + 1);
        background.setSize(sf::Vector2f(texture.getSize().x - 2, 100));
        background.setFillColor(sf::Color::White);

        // Function called to set up color rectangle shapes and button functionality
        createColors(texture.getSize().x, texture.getSize().y);

        // Creates a new window of the map and coloring functionality
        while (window.isOpen())
        {
            sf::Event event;
            ...
            while (window.pollEvent(event))
                ...
                switch (event.type)
                {
                    ...
                    case sf::Event::MouseButtonPressed:
                        ...
                        // Stores the bounds of the buttons and map image
                        ...
                        // Based on where the mouse is clicked, different functionality for buttons
                        ...
                        // If the eraser button was pressed
                        ...
                        // If the DFS Visual button was pressed
                        ...
                        // If the BFS Visual button was pressed
                        ...
                        // If the Quick Fill Button was pressed
                        ...
                        // If the back button is pressed, current window closes and menu button opens
                        ...
                        // If somewhere on the map image was clicked
                        else if (spriteBounds.contains(mousePos.x, mousePos.y))
                        {
                            // If clicked outside the bounds of the map
            ...
            // Draws all images to the window to display
            window.clear();
